...
#---------Finish with loading data according to scaling factor---------	
	...
	#	dstat -tcnmdls --output test.csv 1 $dcount 1>/dev/null &
		...
		#------command to run jdbcrunner benchmark test----
	        ...
	        java JR $1 -warmupTime $wt -measurementTime $mt -nAgents $na -sleepTime $st1,$st2,$st3,$st4,$st5 -jdbcUrl "jdbc:postgresql://172.26.139.4:5432/tpcc" -logDir "./benchmark/$date/Server1/Run$count/jdbcRunnerLogs/" >./benchmark/$date/Server1/Run$count/jdbcRunnerLogs/$tdate.txt    # Print values read in variable
		sleep 15
		
		ssh -n sachin@172.26.139.4 'scp test.csv sachin@172.26.139.5:/home/sachin/jdbcrunner-1.2/'
	...
	#	fi
		...
		ssh -n sachin@172.26.139.4 "scp $fl sachin@172.26.139.5:/home/sachin/jdbcrunner-1.2/benchmark/$date/Server1/Run$count/$log"
...
# Plot results
	...
	ssh -n sachin@172.26.139.4 "scp /db/pgsql922-5432/postgresql.conf sachin@172.26.139.5:/home/sachin/jdbcrunner-1.2/benchmark/$date/"
